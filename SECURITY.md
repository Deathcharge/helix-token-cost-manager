...
- Project, request, dimension, and contract-plan labels may become sensitive if callers put personal or commercial data in them; use opaque identifiers and protect backups.
